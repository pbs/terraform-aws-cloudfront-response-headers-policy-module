...
```hcl
github.com/pbs/terraform-aws-cloudfront-response-headers-policy-module?ref=0.0.27
```
...
module "cloudfront-response-headers-policy" {
  source = "github.com/pbs/terraform-aws-cloudfront-response-headers-policy-module?ref=0.0.27"
